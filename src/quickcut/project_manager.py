"""Project manager for handling QuickCut project lifecycle."""
...
from quickcut.models import ClipRef, ProjectManifest

logger = logging.getLogger(__name__)


class ProjectManager:
    """Manages the creation, loading, and modification of QuickCut projects."""
